...
export const ProvidersList = ({ active, setActive, navItems, href, API_URL, providerId,
  containerId,
  setProviderId,
  setContainerId }) => {
      ...
      <div className="providers-list flex flex-col justify-center items-center">
        {providersList.length > 0 ? (
          providersList.map((provider) => (
            <Provider key={provider.id} provider={provider} API_URL={API_URL} providerId={providerId}
